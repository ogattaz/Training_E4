...
public class RentalProvider extends LabelProvider
	...
	class TNode {
		...
		public Image getImage() {
			...
			if (name == RENTALS_NODE) {
				return pImageRegistry.get(IMG_RENTAL);
			} else if (name == CUSTOMERS_NODE) {
				return pImageRegistry.get(IMG_CUSTOMER);
			} else if (name == OBJECTS_NODE) {
				return pImageRegistry.get(IMG_RENTAL_OBJECT);
			}
			return null;
		}
	...
	public RentalProvider(final ImageRegistry aImageRegistry) {
		initPalette();
	...
	public Image getImage(Object element) {
		...
		if (element instanceof RentalAgency) {
			result = pImageRegistry.get(IMG_AGENCY);
